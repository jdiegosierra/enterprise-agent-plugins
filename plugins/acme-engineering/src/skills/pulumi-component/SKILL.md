...
- **pulumi**: General Pulumi patterns including Output handling, secrets, and aliases
...
Based on [pulumi/agent-skills](https://github.com/pulumi/agent-skills).
